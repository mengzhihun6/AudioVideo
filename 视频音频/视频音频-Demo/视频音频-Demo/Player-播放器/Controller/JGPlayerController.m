...
#import "JGPlayerController.h"
#import "XJAVPlayer.h"


@interface JGPlayerController ()<XJAVPlayerDelegate,UIScrollViewDelegate>{
    XJAVPlayer *myPlayer;
    UIScrollView *scroll;
}
...
@implementation JGPlayerController
...
- (void)viewDidLoad {
    ...
    myPlayer = [[XJAVPlayer alloc] initWithFrame:CGRectMake(0, 70, self.view.frame.size.width, 250)];
